...
/// Аббревиатурой[HP] ниже отмечены элементы, не реализованные в этой книг
/// </summary>
...
public class WeaponDefinition
{
    ...
    public float delayBetweeShots = 0;
...
public class Weapon : MonoBehaviour
{
    ...
    public void SetType(WeaponType wt)
    {
        ...
        lastShotTime = 0; // Сразу после установки „type можно выстрелить // g
    }
    ...
    public void Fire()
        {
            ...
            if (Time.time - lastShotTime < def.delayBetweeShots)
            { // i
                return;
            }
            Projectile p;
